"""
A simple active trainer for GS.
...
import viser
import yaml
from datasets.colmap import Dataset, ActiveDataset, Parser
...
class ActiveRunner:
    ...
    def train(self):
        ...
        initial_loader_iter = iter(initial_loader)
...
def main(local_rank: int, world_rank, world_size: int, cfg: Config):
    ...
    runner = ActiveRunner(local_rank, world_rank, world_size, cfg)
